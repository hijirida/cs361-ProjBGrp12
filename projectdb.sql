...
CREATE TABLE `sponsorships` (`charity_id` int NOT NULL, `donation_amount` int, `sponsorship` int, `cur_steps` int, `sponsor_id` int, PRIMARY KEY(`charity_id`), FOREIGN KEY(`charity_id`) REFERENCES `charity` (`charity_id`), FOREIGN KEY(`sponsor_id`) REFERENCES `sponsor` (`sponsor_id`));
...
INSERT INTO `sponsorships` (`donation_amount`, `sponsorship`, `charity_id`, `sponsor_id`, `cur_steps`) VALUES (100, 10000, 1, 1, 5000);
INSERT INTO `sponsorships` (`donation_amount`, `sponsorship`, `charity_id`, `sponsor_id`, `cur_steps`) VALUES (250, 50000, 2, 2, 15000);
